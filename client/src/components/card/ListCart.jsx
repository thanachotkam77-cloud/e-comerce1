            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='bg-white p-4 rounded-md shadow-md space-y-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        className='bg-red-500 w-full rounded-md text-white py-2 shadow-md hover:bg-red-700'>สั่งซื้อ</button></Link>)
                            :(<Link to={'/login'}>
                        <button className='bg-blue-500 w-full rounded-md text-white py-2 shadow-md hover:bg-blue-700'>Login</button></Link>)
                        }
                        ...
                        <Link to={'/shop'}>
                        <button className='bg-gray-500 w-full rounded-md text-white py-2 shadow-md hover:bg-gray-700'>แก้ไขรายการ</button></Link>
                    </div>
